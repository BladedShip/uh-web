    ...
    return (
        <VariantWrapper title="Trade in." subtitle="Save up to ₹10,000 in credit.">
            <div className="grid grid-cols-2 gap-4">
                ...
                >
                    <p className="text-sm tracking-[-0.03em] leading-[1.2] font-semibold py-2 text-center">
                        Select a smart ring
                    </p>
                </CardWrapper>
                <CardWrapper
            ...
            {tradeInSelected && (
                <div className="flex flex-col gap-2 bg-[#EEEEEE80] p-4 rounded-lg">
                    <p className="text-sm tracking-[-0.03em] leading-[1.2] font-medium pb-3">
                    ...
                    {Object.keys(PRICE_ADDONS_LABELS.tradeIn).map((tradeIn) => (
                        ...
                        >
                            <p>{PRICE_ADDONS_LABELS.tradeIn[tradeIn as keyof typeof PRICE_ADDONS_LABELS.tradeIn]}</p>
                        </CardWrapper>
                    ))}
                    <p className="text-xs tracking-[-0.03em] leading-[1.2] font-medium text-center py-2 text-gray-500">
